...
- **Core Components**:
    - `ConceptBox`: Displays events, calendar items, and expenses with type discrimination and unique gradient backgrounds.
...
### Features
- Real-time data fetching for events, calendar, and expenses.
...
- Visually distinct cards for events (purple-pink), calendar (blue-teal-cyan), and expenses (amber-green).
